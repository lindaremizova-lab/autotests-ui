...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        super().__init__(page)
        self.image_upload_widget = self
        self.create_course_form = self
        self.create_course_toolbar_view = Text(
            page,
            locator="create-course-toolbar-title-text",
            name="Create course toolbar"
        )
        ...
        self.create_course_title_input = page.get_by_placeholder('New course')
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        self.check_visible_image_upload_view(
